...
// Ctrl For Navigation
app.controller('NaviCtrl', function($scope, views, $route, auth, $http, user, infoGrab, bookingGrab, bookings, email) {
    $scope.views = views;
    $scope.user = user;
    $scope.email = email;
...
//    
    ...
    //$scope.displayOneBooking = bookingInfo.displayBookingInfo(null, "Quote");
